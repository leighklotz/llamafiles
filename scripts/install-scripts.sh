...
FILES="ask.sh bashblock.sh codeblock.sh help-commit.sh machelp.sh manhelp.sh nvfree.sh onsubnet.sh repofiles.sh scuttle.sh summarize.sh systype.sh unfence.sh via.sh"
